...
export const idsDto = z
  .array(idDto)
  .min(1, { message: "At least one ID is required" });

export const tenantIdDto = z
  .string()
...
export type AssignPermissionsToRoleDto = z.infer<
  typeof assignPermissionsToRoleDto
>;
export type RemovePermissionsFromRoleDto = z.infer<
  typeof removePermissionsFromRoleDto
>;
export type UpdateRolePermissionScopeDto = z.infer<
  typeof updateRolePermissionScopeDto
>;
export type BulkUpdateRolePermissionsDto = z.infer<
  typeof bulkUpdateRolePermissionsDto
>;
...
export type UpdateUserRoleAssignmentDto = z.infer<
  typeof updateUserRoleAssignmentDto
>;
...
export type CreateUserPermissionOverrideDto = z.infer<
  typeof createUserPermissionOverrideDto
>;
export type UpdateUserPermissionOverrideDto = z.infer<
  typeof updateUserPermissionOverrideDto
>;
export type BulkUserPermissionOverridesDto = z.infer<
  typeof bulkUserPermissionOverridesDto
>;
export type RemoveUserPermissionOverrideDto = z.infer<
  typeof removeUserPermissionOverrideDto
>;
...
export type EffectivePermissionsQueryDto = z.infer<
  typeof effectivePermissionsQueryDto
>;
